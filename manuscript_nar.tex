...
The \textit{OneD} R package and the data used here are
...
\citep{stadhouders2018transcription,ledily2014distinct,encode2012integrated,rao20143d,lin2012global,dixon2012topological}
...
\citep{serra2016structural}. Briefly, after controlling the quality of FASTQ
...
(for more details see \cite{stadhouders2018transcription}). In addition, the
...
in either B cells or ES cells, and from either CRG (Center for Genomic
Regulation) or UCSD (University of California San Diego). The simulation
...
(Supplementary Figures~12 and 13). On this test, \textit{HiCNorm} and \textit{OneD}
...
(figure~\ref{fig:chic}A and Supplementary Figure~14). The performance
...
(Supplementary Figure~15). \textit{vanilla} was the overall fastest method
...
If the purpose is to remove the effect of copy number, then OneD+CN
