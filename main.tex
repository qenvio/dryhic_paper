...
\title[Dryhic]{Dryhic: Increasing Reproducibility of Hi-C Samples with Abnormal Karyotypes}

\author[Vidal \textit{et~al}.]{Enrique Vidal\,$^{\text{\sfb 1,2}*}$, François le Dily\,$^{\text{\sfb 1,2}}$, Javier Quilez\,$^{\text{\sfb 1,2}}$, Ralph Stadhouders\,$^{\text{\sfb 1,2}}$, Yasmina Cuartero\,$^{\text{\sfb 1,2}}$ Guillaume Fillion\,$^{\text{\sfb 1,2}}$ and Miguel Beato\,$^{\text{\sfb 1,2}}$}
...
\abstract{
	...
	\textbf{Results:} The proposed method increases reproducibility among replicas of Hi-C samples with abnormal karyotype and obtained using different protocols. The implementation is fast and scales well in terms of computing resources for resolutions up to 1 Kbp.\\	
	\textbf{Availability:} The strategy proposed is implemented as an R package available at \href{http://www.github.com/qenvio/dryhic}{http://www.github.com/qenvio/dryhic}.\\	
