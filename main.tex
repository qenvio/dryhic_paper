...
\caption{Pearson correlation between the corrected number of contacts per bin
...
karytoypic aberrations, then its genome is grossly different from the reference
