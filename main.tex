...
% Marc's comment here was regarding lack of motivation and explanation for the
% copy number comparison. I've rescued some text from an older version. We
% should also comment here about CN being a bias or providing biological
% information, so to correct or not to correct for CN
