...
%DIFDELCMD < {img/copy_number_figure2.eps}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <   {img/correlation_aberrant_figure3.eps}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
%DIFDELCMD <   {img/correlation_normal_figure4.eps}}
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < \centerline{\includegraphics[width=.49\textwidth]
%DIFDELCMD <   {img/figure_cnv_correction.eps}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\DIFdelbegin %DIFDELCMD < \begin{figure}
%DIFDELCMD < \centerline{\includegraphics[width=.49\textwidth]
%DIFDELCMD <   {img/figure_benchmark_time.eps}}
%DIFDELCMD < %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
