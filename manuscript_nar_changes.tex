...
%DIF DEL /tmp/tmp_old_JRxYzj.tex   Fri Nov 24 16:25:22 2017
%DIF ADD /tmp/tmp_new_8_afKa.tex   Fri Nov 24 16:25:22 2017
...
\DIFdelend %DIF > 
%DIF > \begin{table*}
%DIF > \label{tab:samples}
%DIF > {\begin{tabular}{ccccccc}
%DIF >   \hline
%DIF >   \textbf{Sample ID} & \textbf{Cell type} & \textbf{Application} &
%DIF >   \textbf{RE} & \textbf{Sequencing core} & \textbf{Set(s)} &
%DIF >   \textbf{Source} \\
%DIF >   \hline
%DIF > dc3a1e069\_51720e9cf & T47D & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & T47D, K562 & NA \\
%DIF > b1913e6c1\_51720e9cf & T47D & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & T47D & NA \\
%DIF > dc3a1e069\_ec92aa0bb & T47D & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & T47D, K562 & NA \\
%DIF > HindIII\_T0 & T47D & dilution Hi-C &
%DIF >   HindIII & CRG & T47D & SRR1054341 \\
%DIF > NcoI\_T0    & T47D & dilution Hi-C &
%DIF >   NcoI      & CRG & T47D & SRR1054343 \\
%DIF > ENCLB758KFU & T47D & dilution Hi-C &
%DIF >   HindIII   & UMass & T47D & ENCLB758KFU \\
%DIF > ENCLB183QHG & T47D & dilution Hi-C &
%DIF >   HindIII   & UMass & T47D & ENCLB183QHG \\
%DIF > HIC069  & K562 & \textit{in situ} Hi-C &
%DIF >   MboI & Baylor & T47D, K562 &    SRR1658693 \\
%DIF > HIC070  & K562 & \textit{in situ} Hi-C &
%DIF >   MboI & Baylor & T47D, K562 &    SRR1658694 \\
%DIF > HIC071  & K562 & \textit{in situ} Hi-C &
%DIF >   MboI & Baylor & K562 & SRR1658695,SRR1658696 \\
%DIF > HIC074  & K562 & \textit{in situ} Hi-C &
%DIF >   MboI & Baylor & K562 & SRR1658701,SRR1658702 \\
%DIF > b7fa2d8db\_bfac48760 & B cell  & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > fc3e8b36a\_7bf1bf374 & ES cell & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > b7fa2d8db\_7284b867a & B cell  & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > fc3e8b36a\_38bfd1b33 & ES cell & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > b7fa2d8db\_58e812fc2 & B cell  & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > fc3e8b36a\_c990a254e & ES cell & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > b7fa2d8db\_73f11d923 & B cell  & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > fc3e8b36a\_4bf044f18 & ES cell & \textit{in situ} Hi-C &
%DIF >   DpnII & CRG & mm10 & GSE96611 \\
%DIF > GSM987817 & B cell  & dilution Hi-C &
%DIF >   HindIII & UCSD & mm10 & SRR543428-SRR543431 \\
%DIF > GSM987818 & B cell  & dilution Hi-C &
%DIF >   HindIII & UCSD & mm10 & SRR543432-SRR543442 \\
%DIF > GSM862720 & ES cell & dilution Hi-C &
%DIF >   HindIII & LICR & mm10 & SRR443883-SRR443885 \\
%DIF > GSM862721 & ES cell & dilution Hi-C &
%DIF >   HindIII & LICR & mm10 & SRR400251-SRR400256 \\
%DIF > GSM862722 & ES cell & dilution Hi-C &
%DIF >   NcoI    & LICR & mm10 & SRR443886-SRR443888 \\
%DIF >   \hline
%DIF > \end{tabular}}{}
%DIF > \caption{Hi-C data sets used in this study. Sample ID: Unique sample
%DIF > identifier in the respective projects. Cell type: source of the biological
%DIF > sample. Application: Hi-C protocol. RE: Restriction enzyme used for the
%DIF > digestion. Sequencing core: Laboratory performing the experiment (CRG:
%DIF > Centre for Genomic Regulation; UMass: University of Massachusetts; Baylor:
%DIF > Baylor College of Medicine; UCSD: University of California San Diego;
%DIF > LICR: Ludwig Institue for Cancer Research). Set(s): Sets in which the
%DIF > sample was included (see text for detail).  Source: SRA, GEO or ENCODE raw
%DIF > data identifier.}
%DIF > \end{table*}
%DIF > 
%\end{landscape}
